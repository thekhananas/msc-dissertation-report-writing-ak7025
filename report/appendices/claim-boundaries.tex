...
The project evaluates one pinned external model, two simulators with specified hidden states and observation rules, and one historical educational dataset. It does

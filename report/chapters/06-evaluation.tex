...
unsuccessful, and one missing criterion was reclassified from sandbox execution error to invalid submission. Thus, 17 binary labels
...
Case \texttt{h-c2m2-03} has no valid binary criterion outcome. The original execution was recorded as a sandbox execution error.

...
The saved reports refer to the related-evidence condition as "valid probe". This identifies its intended relation to the target
...
% Draft notation: check whether P(correct | obs) requires sensitivity bounds
